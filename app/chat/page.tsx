...
const ChatProvider = () => {
  ...
  return (
    <ChatContext.Provider value={provider}>
      {isConnected ? (
        <Flex
          style={{ height: 'calc(100% - 56px)', backgroundColor: 'var(--background-color)' }}
          className="relative"
        >
          <>
            <ChatSideBar />
        ...
        <>
          <Navbar />
          <main className="flex min-h-screen flex-col items-center gap-20 p-2 lg:p-12 justify-between z-2 relative bg-[#0657E0]">
            <div
              className={'flex flex-col gap-6 text-center text-xl'}
              style={{ fontFamily: 'PPMondwest-Regular' }}
            >
              <div className="text-7xl">
                <div>On-chain Storybook built by Galadriel</div>
              </div>
              <div className="pt-[100px]">
                ...
                <div className="pt-4 underline">
                  <a href="https://docs.galadriel.com/setting-up-a-wallet" target="_blank">
                    (Galadriel testnet)
                  </a>
                </div>
              </div>
              <div className="text-4xl pt-12">
                To play, visit our{' '}
                <a href="https://discord.gg/4UuffUbkjb" target="_blank" className="px-2 underline">
                  Discord
                </a>{' '}
            ...
            <div
              className={
                'flex w-full flex-col lg:flex-row lg:justify-between items-end text-xl p-4 lg:p-0'
              }
            >
              <Addresses />
              <BuildWithGaladriel />
